...
" Edits from the original github listed below
...
highlight! link cssAttr NightflyWatermelon
highlight! link cssBraces NightflySteel_Blue
highlight! link cssClassName NightflyIndigo
highlight! link cssClassNameDot NightflyViolet
highlight! link cssColor NightflyBlue
highlight! link cssIdentifier NightflyBlue
highlight! link cssProp NightflySteel_Blue
...
highlight! link sassClass NightflyIndigo
...
highlight! link htmlEndTag NightflyWatermelon
highlight! link htmlH1 NightflyWatermelon
highlight! link htmlH2 NightflyOrange
highlight! link htmlTag NightflyWatermelon
highlight! link htmlTagN NightflyBlue
highlight! link htmlTagName NightflySlate_Blue
highlight! link htmlSpecialTagName NightflySlate_Blue
...
highlight! link javaOperator NightflyYellow
highlight! link javaScopeDecl NightflyViolet
highlight! link javaStatement NightflyRed
...
highlight jsAsyncKeyword term=italic
...
highlight! link markdownCode NightflyIndigo
highlight! link markdownCodeDelimiter NightflyTan
highlight! link markdownError NormalNC
highlight! link markdownH1 NightflyViolet
highlight! link markdownH2 NightflyViolet
highlight! link markdownH3 NightflyViolet
highlight! link markdownH4 NightflyViolet
highlight! link markdownLinkText NightflyYellow
highlight! link markdownHeadingRule NightflyBlue
highlight! link markdownItalic NightflyGreen
...
highlight! link jsonKeyword NightflyViolet
highlight! link jsonBoolean NightflyIndigo
highlight! link jsonQuote NightflyWhite
highlight! link jsonString NightflyYellow
